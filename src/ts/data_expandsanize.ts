...
export class ExpanderSanizer<T> {
	...
	static latchAll() {
		for (let expsan of ExpanderSanizer.theMap.values()) {
			expsan.latch();
		}
	}
	...
	constructor(v: ExpanderSanizerData<T>, cleanup: Function | null = null) {
