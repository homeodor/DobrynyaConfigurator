...
{#if $isMacLike}
	<span class="system-mac">
		...
		<span
			...
			on:click={() => addModifier(8)}>⌘</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(2)}>⇧</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(4)}>⌥</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(1)}>⌃</span
		>
	</span>
{:else}
	<span class="system-win">
		...
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(1)}>Ctrl</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(2)}>Shift</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(4)}>Alt</span
		>
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<span
			class="cbm-keycombo-addmodifier"
			data-keyboardcatcher="1"
			on:click={() => addModifier(8)}>Win</span
		>
	</span>
{/if}
<br />
